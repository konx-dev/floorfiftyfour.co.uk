        ...
        <div v-for="(article, index) in articles" :key="index">
            ...
            <div v-show="activeItem === index" class="text-left md:text-center text-white text-sm md:text-lg px-4 pb-6">
                ...
                <div class="text-center my-6">
                    <nuxt-link class="btn py-4 px-24 border border-white hover:bg-white hover:text-black cursor-pointer w-full md:w-auto" :to="'/blog/' + article.slug">Read Post</nuxt-link>
                </div>
            </div>
        </div>
    </div>
