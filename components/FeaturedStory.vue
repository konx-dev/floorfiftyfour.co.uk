<template>
        <div v-if="featuredStory" class="featured-card__container font-primary py-20 md:py-40" :style="{ backgroundImage: `url('${featuredImage}')` }">
            ...
            <!-- <div class="featured-card__inner__subheading font-bold text-black text-xs mx-auto w-48 py-2 text-center z-10" v-html="featuredStory.hero[0].subHeading"></div> -->
            
            <!-- <v-img class="absolute w-full h-full object-cover" v-if="featuredStory.hero[0].featuredImage[0]" :src="featuredStory.hero[0].featuredImage[0].filename" :alt="featuredStory.hero[0].featuredImage[0].title" /> -->
        </div>
</template>
<script>
